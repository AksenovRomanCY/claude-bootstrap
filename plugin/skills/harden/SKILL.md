...
1. **Parse arguments**
   ...
   - Allow only `--baseline`, `--dry-run`, and `--check`
...
10. **Summarize**
    ...
    - Suggest committing `.claude/settings.json`, `.claude/security-policy.json`, and `.claude/rules/common/destructive-operations.md`
