...
5. **Check hooks** — verify files in `~/.claude/hooks/`:
   ...
   - Guard modules: `guard/__init__.py`, `guard/context.py`, `guard/decisions.py`, `guard/filesystem.py`, `guard/git.py`, `guard/rules.py`, `guard/shell.py`
...
7. **Summary** — output a table:
   ...
   Agents:     4/4 — OK
   Skills:     11/11 — OK
   Hooks:      13/13 files, shell scripts executable — OK
