...
assert_contains "$SKILL" "--profile \"\$PROFILE\" --dry-run" "skill previews selected profile with apply_profile dry-run"
assert_contains "$SKILL" "--profile \"\$PROFILE\" --check" "skill checks selected profile drift with apply_profile"
