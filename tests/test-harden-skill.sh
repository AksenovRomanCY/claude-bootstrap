...
assert_contains "$SKILL" "--profile baseline --remove --dry-run" "skill previews remove mode"
assert_contains "$SKILL" "--profile baseline --remove" "skill applies remove mode"
